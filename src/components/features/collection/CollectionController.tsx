...
export function CreateCollectionDialog(props: CreateCollectionDialogProps) {
    ...
    return (
      <div>
        ...
        <Typography variant="body1">
          Display name: {collectionBuilder.collectionForm.info?.displayName}
        </Typography>
        <Typography variant="body1">
          API path: {collectionBuilder.collectionForm.collectionName}
        </Typography>
        <Typography variant="body1">
          Description: {collectionBuilder.collectionForm.info?.description}
        </Typography>
        <Typography variant="body1">Attributes:</Typography>
        {collectionBuilder.collectionForm.attributes.map((attr, index) => (
  ...
  const CollectionSteppers = () => {
    ...
    const [collectionDescriptionInput, setCollectionDescriptionInput] =
      React.useState(collectionBuilder.collectionForm.info?.description ?? "");
    ...
    React.useEffect(() => {
      ...
      console.log("Collection form: ", collectionBuilder.collectionForm);
      switch (activeStep) {
        ...
        case 0:
          ...
          break;
        case 1:
          if (collectionBuilder.collectionForm.attributes.length === 0) {
            setNextStepDisabled(true);
          } else {
            setNextStepDisabled(false);
          }
    ...
    const onAddAnotherAttributeSubmit = (settings: AttributeSettingTypes) => {
